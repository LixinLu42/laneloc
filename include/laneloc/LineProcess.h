...
namespace laneloc
{
    ...
    class LineProcess
    {
        public:
            ...
            void get_cross_point_left(int &cross_up_x_left, int &cross_up_y_left, int &cross_down_x_left, 
                                                   int &cross_down_y_left, double mean_x_start, double mean_y_start, double K_right);

            void get_cross_point_right(int &cross_up_x_right, int &cross_up_y_right, int &cross_down_x_right, 
                                                   int &cross_down_y_right, double mean_x_start, double mean_y_start, double K_right);

	        void get_Unitstep(int &minstep, double &xUnitstep, double &yUnitstep, int cross_up_x, int cross_up_y,
